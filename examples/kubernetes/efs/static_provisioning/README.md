...
```sh
>> kubectl apply -f examples/kubernetes/efs/static_provisioning/specs/storageclass.yaml
>> kubectl apply -f examples/kubernetes/efs/static_provisioning/specs/pv.yaml
>> kubectl apply -f examples/kubernetes/efs/static_provisioning/specs/claim.yaml
```
...
```
>> kubectl apply -f examples/kubernetes/efs/static_provisioning/specs/pod.yaml
```
