...
1. Create a storage class for Amazon EFS.
   ...
   2. Download a `StorageClass` manifest for Amazon EFS.
      ...
      ```sh
      curl -O https://raw.githubusercontent.com/kubernetes-sigs/aws-efs-csi-driver/master/examples/kubernetes/efs/dynamic_provisioning/specs/storageclass.yaml
      ```
...
2. Test automatic provisioning by deploying a Pod that makes use of the PVC: 
   ...
   1. Download a manifest that deploys a Pod and a PVC.
      ...
      ```sh
      curl -O https://raw.githubusercontent.com/kubernetes-sigs/aws-efs-csi-driver/master/examples/kubernetes/efs/dynamic_provisioning/specs/pod.yaml
      ```
