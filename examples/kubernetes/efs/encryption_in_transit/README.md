...
>> kubectl apply -f examples/kubernetes/efs/encryption_in_transit/specs/pv.yaml
>> kubectl apply -f examples/kubernetes/efs/encryption_in_transit/specs/claim.yaml
>> kubectl apply -f examples/kubernetes/efs/encryption_in_transit/specs/pod.yaml
```
