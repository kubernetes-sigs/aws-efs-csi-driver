...
require (
	...
	k8s.io/apiserver v0.18.10 // indirect
	k8s.io/cloud-provider v0.18.10 // indirect
	k8s.io/component-base v0.18.10 // indirect
	k8s.io/cri-api v0.0.0 // indirect
	k8s.io/csi-translation-lib v0.18.10 // indirect
