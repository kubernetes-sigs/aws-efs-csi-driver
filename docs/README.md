...
|----------------|-------------------------------------------------------------------------------|
| v2.0.1         | public.ecr.aws/efs-csi-driver/amazon/aws-efs-csi-driver:v2.0.1                |
...
Then, update all lines referencing `image: amazon/aws-efs-csi-driver` to the desired version (e.g., to `image: amazon/aws-efs-csi-driver:v2.0.1`) in the yaml file, and deploy driver yaml again:
```sh
