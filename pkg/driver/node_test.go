...
func setup(mockCtrl *gomock.Controller, volStatter VolStatter, volMetricsOptIn bool) (*MockMounter, *Driver, context.Context) {
	mockMounter := NewMockMounter(mockCtrl)
