...
func (m *MockCloud) DescribeAccessPoints(arg0 context.Context, arg1 string, arg2 int64) ([]*cloud.AccessPoint, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeAccessPoints", arg0, arg1, arg2)
	ret0, _ := ret[0].([]*cloud.AccessPoint)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCloudMockRecorder) DescribeAccessPoints(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeAccessPoints", reflect.TypeOf((*MockCloud)(nil).DescribeAccessPoints), arg0, arg1, arg2)
}
