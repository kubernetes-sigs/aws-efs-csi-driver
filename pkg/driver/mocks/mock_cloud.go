...
// DescribeFileSystemById mocks base method.
func (m *MockCloud) DescribeFileSystemById(ctx context.Context, fileSystemId string) (*cloud.FileSystem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeFileSystemById", ctx, fileSystemId)
	ret0, _ := ret[0].(*cloud.FileSystem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DescribeFileSystemById indicates an expected call of DescribeFileSystemById.
func (mr *MockCloudMockRecorder) DescribeFileSystemById(ctx, fileSystemId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeFileSystemById", reflect.TypeOf((*MockCloud)(nil).DescribeFileSystemById), ctx, fileSystemId)
}
...
// DescribeFileSystemByToken indicates an expected call of DescribeFileSystemByToken.
func (mr *MockCloudMockRecorder) DescribeFileSystemByToken(ctx, creationToken interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeFileSystemByToken", reflect.TypeOf((*MockCloud)(nil).DescribeFileSystemByToken), ctx, creationToken)
}
